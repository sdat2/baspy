...
def cmap_centre_to_white(cmap, nlevs):
    ...
    n_contours = nlevs + 1
    n_points_within_1contour = np.round(255.0 / n_contours)
    ...
    if n_contours % 2 == 0:
        ...
        ### n_contours is odd
        lower_bound = int(127 - np.round(n_points_within_1contour / 2.0))
        upper_bound = int(127 + np.round(n_points_within_1contour / 2.0))
